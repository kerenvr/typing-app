    ...
    return (
        <div className={styles.container}>
            ...
            <div className="relative inline-flex group">
                ...
                <div className='relative inline-flex items-center justify-center space-x-4 px-8 py-2 text-lg transition-all duration-200 font-pj bg-[var(--text)] text-white rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900' onClick={handleStartTyping}>
